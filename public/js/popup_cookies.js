// GENERAL SCRIPT
function Pop(){var conDivObj;var fadeInTime=10;var fadeOutTime=10;let cookie={name:"cookieconsent_status",path:"/",expiryDays:365*24*60*60*5000,};let content={message:"This website uses cookies to ensure you get the best experience on our website.",btnText:"Got it!",mode:"  banner bottom",theme:" theme-classic",palette:" palette1",link:"Learn more",href:"https://www.cookiesandyou.com",target:"_blank",};let createPopUp=function(){if(typeof conDivObj==="undefined"){conDivObj=document.createElement("DIV");conDivObj.style.opacity=0;conDivObj.setAttribute("id","spopupCont");}
...
content.message+
'<br><a id="plcy-lnk" class="policylink" href="'+
content.href+
'"'+
" target="+
content.target+
...
content.btnText+
'</a></div></div>';document.body.insertBefore(conDivObj, document.getElementsByTagName("script")[0]);fadeIn(conDivObj);document.getElementById("cookie-btn").addEventListener("click",function(){saveCookie();fadeOut(conDivObj);});};let fadeOut=function(element){var op=1;var timer=setInterval(function(){if(op<=0.1){clearInterval(timer);conDivObj.parentElement.removeChild(conDivObj);}
...
// CUSTOM SCRIPT
// Palette: palette1 to palette8; Mode: floating || banner + right || left; Theme: block || edgeless || classic || wire; Time: 5 || 10 || 15 || 20;
window.start.init({Palette:"palette4",Mode:"floating left",Theme:"classic",Message:"Ce site n'utilise que des cookies essentiels nécessaires à son bon fonctionnement.",ButtonText:"J'ai compris",Location:"?ml",LinkText:"Voir les mentions légales",Time:"0",Target:""});